...
class WritePeriodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentWritePeriodBinding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_write_period, container, false)
    ...
    fun settingEvent() {
        ...
        fragmentWritePeriodBinding.apply {
            ...
            textinputWritePeriod.setOnClickListener {
                ...
                // 뷰를 설정한다
                val dialogWritePeriodFragmentBinding =
                    DialogWritePeriodFragmentBinding.inflate(layoutInflater)
                builder.setView(dialogWritePeriodFragmentBinding.root)
