...
class ProfileViewModel : ViewModel() {
    ...
    // 사용자가 참여한 스터디 리스트
    private val _profilePartStudyList = MutableStateFlow<List<StudyData>?>(null)
    val profilePartStudyList: MutableStateFlow<List<StudyData>?> = _profilePartStudyList

    // 사용자가 진행한 스터디 리스트
    private val _profileHostStudyList = MutableStateFlow<List<StudyData>?>(null)
    val profileHostStudyList: MutableStateFlow<List<StudyData>?> = _profileHostStudyList
